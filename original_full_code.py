...
# from season_averages import averages
...
def run():
    app.run(host='172.240.238.101', port=8000)
...
@bot.command()
async def averages_command(ctx, *, player_name):
    await averages(ctx, bot, player_name=player_name)
